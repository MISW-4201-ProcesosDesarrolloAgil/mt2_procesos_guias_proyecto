...
|--------------------------------------------------|--------------------------------------------------|-------------------------------------------------------------|-------------|
|Estrategia de arquitectura [1] | Seleccionar una estrategia de arquitectura       | Arquitectura existente / Una sola propuesta de arquitectura | El equipo tendrá que realizar los ajustes necesarios a la arquitectura de la aplicación base para satisfacer los nuevos requerimientos.      |
...
| | Definir el nivel de detalle del documento de arquitectura    | Alto nivel                                                  | El documento para la definición de la arquitectura de la aplicación es bastante conciso y sólo contempla el diseño de 4 vistas de arquitectura.           |
